...
import { compareExposure, computeExposure, loadScenario } from './api';
import {
...
export function App() {
  ...
  const layers = useMemo(() => {
    ...
    return nextLayers;
  }, [camera, draftPolygon, drawKind, exposure, interactionMode, layerToggles, preferencePolygons, route, scenario, studyCondition]);
